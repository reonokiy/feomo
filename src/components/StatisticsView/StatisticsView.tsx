...
import { statusStore, memoFilterStore } from "@/store";
import type { FilterFactor } from "@/store/memoFilter";
...
const StatisticsView = observer(() => {
  ...
  const pinnedCount = useMemo(() => {
    ...
    return statuses.filter((status) => status?.pinned).length;
